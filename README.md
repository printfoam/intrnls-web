...
This repo was split out of a private internal repo on 2026-08-20 so the public marketing
site could be hosted on GitHub Pages on its own. This repo starts its own git history — it does
not carry the source repo's commits. Design-process material (rejected photo candidates, raw
